...
from .transformer_2d import MVTransformer2DModel as Transformer2DModel
...
class MVCrossAttnDownBlock2D(CrossAttnDownBlock2D):
    def __init__(
        self,
        *args, **kwargs
    ):
...
class MVCrossAttnUpBlock2D(CrossAttnUpBlock2D):
    def __init__(
        self,
        *args, **kwargs
    ):
...
class MVUNetMidBlock2DCrossAttn(UNetMidBlock2DCrossAttn):
    def __init__(
        self,
        *args, **kwargs
    ):
