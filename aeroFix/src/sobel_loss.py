...
class GradLayer(nn.Module):
    ...
    def get_gray(self,x):
        ...
        gray_coeffs = [0.2989, 0.5870, 0.1140]  # Standard RGB to grayscale conversion coefficients
        convert = x.new_tensor(gray_coeffs).view(1, 3, 1, 1)
...
class SobelLoss(nn.Module):
    ...
    def __init__(self, reduction="l2"):
...
if __name__ == "__main__":
    ...
    net = GradLayer()
    img = cv2.imread('test_samples.png')
